title: 大前端进阶
author: lwl
cover: https://fastly.jsdelivr.net/gh/code-anan/image/20220408193654.png
tags:
  - NodeJS
categories:
  - 记录
...
运行第一条node指令![](https://fastly.jsdelivr.net/gh/code-anan/image/20220406111906.png)

## Nodejs实现HttpServlet服务

![](https://fastly.jsdelivr.net/gh/code-anan/image/20220406113349.png)

![](https://fastly.jsdelivr.net/gh/code-anan/image/20220406113406.png)
...
![](https://fastly.jsdelivr.net/gh/code-anan/image/20220406132403.png)
...
![](https://fastly.jsdelivr.net/gh/code-anan/image/20220406134144.png)

如果使用let![](https://fastly.jsdelivr.net/gh/code-anan/image/20220406134223.png)
...
![](https://fastly.jsdelivr.net/gh/code-anan/image/20220406145409.png)
...
6. 执行（最好在cmd下）`babel src -d dist`表示把src下所有的node文件都转换到dist目录下![](https://fastly.jsdelivr.net/gh/code-anan/image/20220408114146.png)
...
![](https://fastly.jsdelivr.net/gh/code-anan/image/20220408141120.png)
...
![](https://fastly.jsdelivr.net/gh/code-anan/image/20220408143025.png)
...
![](https://fastly.jsdelivr.net/gh/code-anan/image/20220408162736.png)
...
然后执行`webpack`就可以得到合并的js文件，并且生成一个html页进行测试得到确实生成为一个js文件了![](https://fastly.jsdelivr.net/gh/code-anan/image/20220408164835.png)
